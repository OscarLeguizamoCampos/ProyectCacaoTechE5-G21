...
const Footer = () => {
  return (
    <footer class="  bg-gray-200 z-10 border-gray-300 border-opacity-50    footer" >
      ...
      <ul class="footer3 col-3">
        <p class="text-center text-mute  border-gray-300 border-opacity-50 border-t-2 p-3 ">GRUPO 51 E-5 © Misión TIC 2022</p></ul>
    </footer>
